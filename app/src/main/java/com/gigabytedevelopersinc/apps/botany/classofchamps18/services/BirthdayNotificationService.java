...
public class BirthdayNotificationService extends JobService {
    ...
    private void studentBirthdayNotification() {
            ...
            if (todayString.equals(studentsModel.getDob())){
                ...
                NotificationCompat.Builder builder =
                        new NotificationCompat.Builder(this)
                                .setSmallIcon(R.mipmap.coc_logo_notify)
                                .setSound(Uri.parse("android.resource://"+getApplicationContext().getPackageName()+"/"+R.raw.closure))
                                .setContentTitle("Class of Champions Notification")
                                .setContentText("Hello! Someone has a Birthday today!");
                Intent notificationIntent = new Intent(this, MainActivity.class);
                notificationIntent.putExtra("From", "notifyNewsFragment");
                notificationIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                PendingIntent contentIntent = PendingIntent.getActivity(this, 0, notificationIntent,
                        PendingIntent.FLAG_UPDATE_CURRENT);
                builder.setContentIntent(contentIntent);
                NotificationManager manager = (NotificationManager) this.getSystemService(Context.NOTIFICATION_SERVICE);
                /*MediaPlayer mpNotifySound = MediaPlayer.create(getApplicationContext(), R.raw.closure);
                mpNotifySound.start();*/
