...
import com.gigabytedevelopersinc.apps.botany.classofchamps18.adapters.BirthdayAdapter;
...
public class HomeNewsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Check if there is network and fill in the birthday list based on the person's day from
        // the listFull
        if (haveNetworkConnection()){
            for (StudentsModel studentsModel : listFull){
                if (todayString.equals(studentsModel.getDob())){
                    BirthdayModel birthdayModel = new BirthdayModel(studentsModel.getStudentImage(),
                            studentsModel.getStudentName(),
                            studentsModel.getNickName(),
    ...
    public void sendNotification() {
        ...
        mBuilder.setSmallIcon(R.drawable.birthday);
    ...
    public String getTime(List<StudentsModel> listFull){
        Date todayDate = Calendar.getInstance().getTime();
        SimpleDateFormat formatter = new SimpleDateFormat("dd"+ " "+"MMMM");
        String todayString = formatter.format(todayDate);
        ...
        for (StudentsModel studentsModel : listFull){
            if (todayString.equals(studentsModel.getDob())){
                birthday = "Someone has a birthday today";
            }
        }
